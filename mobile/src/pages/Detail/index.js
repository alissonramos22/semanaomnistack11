...
export default function Detail(){
    ...
    const message = `Olá ONG, estou entrando em contato pois, gostaria de ajusar no caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR', {  style: 'currency', currency: 'BRL' }).format(incident.value)}`;
